...
public class GoogleAuthorizeUtil {
    private static final String TOKENS_DIRECTORY_PATH = "GoogleSheetsJava/tokens";
    public static Credential authorize() throws IOException, GeneralSecurityException {
        InputStream in = GoogleAuthorizeUtil.class.getResourceAsStream("/credentials.json");
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JacksonFactory.getDefaultInstance(), new InputStreamReader(in));
        List<String> scopes = Arrays.asList(DriveScopes.DRIVE_METADATA,DriveScopes.DRIVE_SCRIPTS,DriveScopes.DRIVE_FILE, SheetsScopes.SPREADSHEETS,SheetsScopes.DRIVE,SheetsScopes.DRIVE_FILE);
